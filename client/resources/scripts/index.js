...
function handleEditClick(){
    ...
    buttonHtml += "<button class=\"btn btn-warning btn-lg btn-cancle\" onclick=\"handleCancel()\">Cancel,/button>"
...
function handleNewClick(){
    ...
    buttonHtml += "<button class=\"btn btn-warning btn-lg btncancle\" onclick=\"handleCancelSave()\">Cancel</button>"
    document.getElementById("saveButton").style.display = "inline-block";
}
